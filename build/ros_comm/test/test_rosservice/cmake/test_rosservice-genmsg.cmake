...
get_filename_component(_filename "/home/edward/catkin_ws/src/ros_comm/test/test_rosservice/srv/HeaderEcho.srv" NAME_WE)
add_custom_target(_test_rosservice_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "test_rosservice" "/home/edward/catkin_ws/src/ros_comm/test/test_rosservice/srv/HeaderEcho.srv" "std_msgs/Header"
)
...
_generate_srv_cpp(test_rosservice
  "/home/edward/catkin_ws/src/ros_comm/test/test_rosservice/srv/HeaderEcho.srv"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/test_rosservice)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/test_rosservice\")")
  # install generated code
  install(
