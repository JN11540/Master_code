#ifndef OBJECT_DETECTOR_V3_INCLUDE_GUARD_HPP
#define OBJECT_DETECTOR_V3_INCLUDE_GUARD_HPP
/// \file
...
public:
    ObjectDetectorV3(ros::NodeHandle &nh) : raw_pc_sub_(nh, "velodyne_points", 100),
                                            ...
                                            tfListener_(tfBuffer_)
    {
        ...
        sync_.registerCallback(boost::bind(&ObjectDetectorV3::mask_callback, this, _1, _2));
    ...
    */
    ...
    void test(PointCloud::Ptr object_cloud);
    ...
    */
    ...
    // void find_2D_convex_hull(PointCloud::Ptr in_cloud);
