...
class ObjectMap:
    ...
    def __init__(self):
        ...
        self.people_sub_ = rospy.Subscriber("/new_hdl_people_tracking_nodelet/markers", MarkerArray, self.contact_time_and_distance_callback, queue_size=10)
        ...
        self.dist_thresh_ = 0.4 # the distance from a person to an object for the object to be considered as occupied
        self.need_clean_thresh_ = 16 # how many frame an object is occupied make it needs to be cleaned
