...
if("TRUE" STREQUAL "TRUE")
  set(rosgraph_msgs_SOURCE_PREFIX /home/edward/catkin_ws/src/ros_comm_msgs/rosgraph_msgs)
  set(rosgraph_msgs_DEVEL_PREFIX /home/edward/catkin_ws/devel)
  ...
  set(rosgraph_msgs_INSTALL_PREFIX /home/edward/catkin_ws/install)
...
if(NOT "/home/edward/catkin_ws/devel/include " STREQUAL " ")
  ...
  elseif(NOT "http://ros.org/wiki/rosgraph_msgs " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/rosgraph_msgs' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rosgraph_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'rosgraph_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/edward/catkin_ws/src/ros_comm_msgs/rosgraph_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT rosgraph_msgs_NUM_DUMMY_TARGETS)
      set(rosgraph_msgs_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::rosgraph_msgs::wrapped-linker-option${rosgraph_msgs_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR rosgraph_msgs_NUM_DUMMY_TARGETS "${rosgraph_msgs_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::rosgraph_msgs::wrapped-linker-option${rosgraph_msgs_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND rosgraph_msgs_LIBRARIES "${interface_target_name}")
...
set(rosgraph_msgs_EXPORTED_TARGETS "rosgraph_msgs_generate_messages_cpp;rosgraph_msgs_generate_messages_eus;rosgraph_msgs_generate_messages_lisp;rosgraph_msgs_generate_messages_nodejs;rosgraph_msgs_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${rosgraph_msgs_dep}_FOUND)
      find_package(${rosgraph_msgs_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rosgraph_msgs_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(rosgraph_msgs_EXPORTED_TARGETS ${${rosgraph_msgs_dep}_EXPORTED_TARGETS})
endforeach()
