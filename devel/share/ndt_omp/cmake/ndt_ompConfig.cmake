...
if("TRUE" STREQUAL "TRUE")
  set(ndt_omp_SOURCE_PREFIX /home/edward/catkin_ws/src/ndt_omp)
  set(ndt_omp_DEVEL_PREFIX /home/edward/catkin_ws/devel)
  set(ndt_omp_INSTALL_PREFIX "")
  set(ndt_omp_PREFIX ${ndt_omp_DEVEL_PREFIX})
else()
  set(ndt_omp_SOURCE_PREFIX "")
  set(ndt_omp_DEVEL_PREFIX "")
  set(ndt_omp_INSTALL_PREFIX /home/edward/catkin_ws/install)
...
if(NOT "/home/edward/catkin_ws/src/ndt_omp/include " STREQUAL " ")
  set(ndt_omp_INCLUDE_DIRS "")
  set(_include_dirs "/home/edward/catkin_ws/src/ndt_omp/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ndt_omp' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/edward/catkin_ws/src/ndt_omp/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT ndt_omp_NUM_DUMMY_TARGETS)
      set(ndt_omp_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::ndt_omp::wrapped-linker-option${ndt_omp_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR ndt_omp_NUM_DUMMY_TARGETS "${ndt_omp_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::ndt_omp::wrapped-linker-option${ndt_omp_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND ndt_omp_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(ndt_omp_EXPORTED_TARGETS ${${ndt_omp_dep}_EXPORTED_TARGETS})
endforeach()
