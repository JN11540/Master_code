...
if("TRUE" STREQUAL "TRUE")
  set(rosbag_SOURCE_PREFIX /home/edward/catkin_ws/src/ros_comm/tools/rosbag)
  set(rosbag_DEVEL_PREFIX /home/edward/catkin_ws/devel)
  set(rosbag_INSTALL_PREFIX "")
  set(rosbag_PREFIX ${rosbag_DEVEL_PREFIX})
else()
  set(rosbag_SOURCE_PREFIX "")
  set(rosbag_DEVEL_PREFIX "")
  set(rosbag_INSTALL_PREFIX /home/edward/catkin_ws/install)
...
if(NOT "/home/edward/catkin_ws/src/ros_comm/tools/rosbag/include " STREQUAL " ")
  set(rosbag_INCLUDE_DIRS "")
  set(_include_dirs "/home/edward/catkin_ws/src/ros_comm/tools/rosbag/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosbag' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/edward/catkin_ws/src/ros_comm/tools/rosbag/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT rosbag_NUM_DUMMY_TARGETS)
      set(rosbag_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::rosbag::wrapped-linker-option${rosbag_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR rosbag_NUM_DUMMY_TARGETS "${rosbag_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::rosbag::wrapped-linker-option${rosbag_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND rosbag_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(rosbag_EXPORTED_TARGETS ${${rosbag_dep}_EXPORTED_TARGETS})
endforeach()
