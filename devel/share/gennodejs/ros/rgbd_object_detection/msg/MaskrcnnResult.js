...
class MaskrcnnResult {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MaskrcnnResult(null);
  ...
  static datatype() {
    ...
    return 'rgbd_object_detection/MaskrcnnResult';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'd917c3c8bcf1773974d71f637e6ff807';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MaskrcnnResult(null);
