...
if("TRUE" STREQUAL "TRUE")
  set(interactive_markers_SOURCE_PREFIX /home/edward/catkin_ws/src/interactive_markers)
  set(interactive_markers_DEVEL_PREFIX /home/edward/catkin_ws/devel)
  ...
  set(interactive_markers_INSTALL_PREFIX /home/edward/catkin_ws/install)
...
if(NOT "/home/edward/catkin_ws/src/interactive_markers/include " STREQUAL " ")
  set(interactive_markers_INCLUDE_DIRS "")
  set(_include_dirs "/home/edward/catkin_ws/src/interactive_markers/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "http://ros.org/wiki/interactive_markers " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/interactive_markers' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Dharini Dutia <dharini@openrobotics.org>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'interactive_markers' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'interactive_markers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/edward/catkin_ws/src/interactive_markers/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT interactive_markers_NUM_DUMMY_TARGETS)
      set(interactive_markers_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::interactive_markers::wrapped-linker-option${interactive_markers_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR interactive_markers_NUM_DUMMY_TARGETS "${interactive_markers_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::interactive_markers::wrapped-linker-option${interactive_markers_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND interactive_markers_LIBRARIES "${interface_target_name}")
...
set(depends "roscpp;rosconsole;rospy;tf2_ros;std_msgs;visualization_msgs")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${interactive_markers_dep}_FOUND)
      find_package(${interactive_markers_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${interactive_markers_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(interactive_markers_EXPORTED_TARGETS ${${interactive_markers_dep}_EXPORTED_TARGETS})
endforeach()
