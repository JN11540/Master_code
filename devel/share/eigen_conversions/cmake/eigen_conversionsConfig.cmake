...
if("TRUE" STREQUAL "TRUE")
  set(eigen_conversions_SOURCE_PREFIX /home/edward/catkin_ws/src/geometry/eigen_conversions)
  set(eigen_conversions_DEVEL_PREFIX /home/edward/catkin_ws/devel)
  ...
  set(eigen_conversions_INSTALL_PREFIX /home/edward/catkin_ws/install)
...
if(NOT "/home/edward/catkin_ws/src/geometry/eigen_conversions/include;/usr/include/eigen3;/usr/share/orocos_kdl/cmake/../../../include " STREQUAL " ")
  set(eigen_conversions_INCLUDE_DIRS "")
  set(_include_dirs "/home/edward/catkin_ws/src/geometry/eigen_conversions/include;/usr/include/eigen3;/usr/share/orocos_kdl/cmake/../../../include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "http://ros.org/wiki/eigen_conversions " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/eigen_conversions' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'eigen_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/edward/catkin_ws/src/geometry/eigen_conversions/${idir}'.  ${_report}")
    endif()
    _list_append_unique(eigen_conversions_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "eigen_conversions;orocos-kdl")
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT eigen_conversions_NUM_DUMMY_TARGETS)
      set(eigen_conversions_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::eigen_conversions::wrapped-linker-option${eigen_conversions_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR eigen_conversions_NUM_DUMMY_TARGETS "${eigen_conversions_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::eigen_conversions::wrapped-linker-option${eigen_conversions_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND eigen_conversions_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${eigen_conversions_dep}_FOUND)
      find_package(${eigen_conversions_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${eigen_conversions_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(eigen_conversions_EXPORTED_TARGETS ${${eigen_conversions_dep}_EXPORTED_TARGETS})
endforeach()
