...
if("TRUE" STREQUAL "TRUE")
  set(rosmsg_SOURCE_PREFIX /home/edward/catkin_ws/src/ros_comm/tools/rosmsg)
  set(rosmsg_DEVEL_PREFIX /home/edward/catkin_ws/devel)
  set(rosmsg_INSTALL_PREFIX "")
  set(rosmsg_PREFIX ${rosmsg_DEVEL_PREFIX})
else()
  set(rosmsg_SOURCE_PREFIX "")
  set(rosmsg_DEVEL_PREFIX "")
  set(rosmsg_INSTALL_PREFIX /home/edward/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://wiki.ros.org/rosmsg " STREQUAL " ")
    set(_report "Check the website 'http://wiki.ros.org/rosmsg' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rosmsg' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'rosmsg' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/edward/catkin_ws/src/ros_comm/tools/rosmsg/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT rosmsg_NUM_DUMMY_TARGETS)
      set(rosmsg_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::rosmsg::wrapped-linker-option${rosmsg_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR rosmsg_NUM_DUMMY_TARGETS "${rosmsg_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::rosmsg::wrapped-linker-option${rosmsg_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND rosmsg_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${rosmsg_dep}_FOUND)
      find_package(${rosmsg_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rosmsg_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(rosmsg_EXPORTED_TARGETS ${${rosmsg_dep}_EXPORTED_TARGETS})
endforeach()
