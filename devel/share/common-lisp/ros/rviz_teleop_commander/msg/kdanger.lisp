...
(cl:defmethod cl:initialize-instance :after ((m <kdanger>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'kdanger)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rviz_teleop_commander-msg:<kdanger> is deprecated: use rviz_teleop_commander-msg:kdanger instead.")))

(cl:ensure-generic-function 'k-val :lambda-list '(m))
(cl:defmethod k-val ((m <kdanger>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rviz_teleop_commander-msg:k-val is deprecated.  Use rviz_teleop_commander-msg:k instead.")
  (k m))

(cl:ensure-generic-function 'ids-val :lambda-list '(m))
(cl:defmethod ids-val ((m <kdanger>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rviz_teleop_commander-msg:ids-val is deprecated.  Use rviz_teleop_commander-msg:ids instead.")
  (ids m))
