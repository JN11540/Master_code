...
(cl:defmethod cl:initialize-instance :after ((m <HumanGazebo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HumanGazebo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rviz_teleop_commander-msg:<HumanGazebo> is deprecated: use rviz_teleop_commander-msg:HumanGazebo instead.")))

(cl:ensure-generic-function 'item_name-val :lambda-list '(m))
(cl:defmethod item_name-val ((m <HumanGazebo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rviz_teleop_commander-msg:item_name-val is deprecated.  Use rviz_teleop_commander-msg:item_name instead.")
  (item_name m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<HumanGazebo>)))
  ...
  "rviz_teleop_commander/HumanGazebo")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'HumanGazebo)))
  "Returns string type for a message object of type 'HumanGazebo"
  "rviz_teleop_commander/HumanGazebo")
