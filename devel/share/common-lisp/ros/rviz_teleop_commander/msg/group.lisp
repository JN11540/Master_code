...
(cl:defmethod cl:initialize-instance :after ((m <group>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'group)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rviz_teleop_commander-msg:<group> is deprecated: use rviz_teleop_commander-msg:group instead.")))

(cl:ensure-generic-function 'eps-val :lambda-list '(m))
(cl:defmethod eps-val ((m <group>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rviz_teleop_commander-msg:eps-val is deprecated.  Use rviz_teleop_commander-msg:eps instead.")
  (eps m))

(cl:ensure-generic-function 'minpts-val :lambda-list '(m))
(cl:defmethod minpts-val ((m <group>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rviz_teleop_commander-msg:minpts-val is deprecated.  Use rviz_teleop_commander-msg:minpts instead.")
  (minpts m))
