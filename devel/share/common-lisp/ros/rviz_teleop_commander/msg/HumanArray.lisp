...
(cl:defclass <HumanArray> (roslisp-msg-protocol:ros-message)
  ((humans
    :reader humans
    :initarg :humans
    :type (cl:vector rviz_teleop_commander-msg:Human)
   :initform (cl:make-array 0 :element-type 'rviz_teleop_commander-msg:Human :initial-element (cl:make-instance 'rviz_teleop_commander-msg:Human))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <HumanArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HumanArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rviz_teleop_commander-msg:<HumanArray> is deprecated: use rviz_teleop_commander-msg:HumanArray instead.")))

(cl:ensure-generic-function 'humans-val :lambda-list '(m))
(cl:defmethod humans-val ((m <HumanArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rviz_teleop_commander-msg:humans-val is deprecated.  Use rviz_teleop_commander-msg:humans instead.")
  (humans m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <HumanArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'humans)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'rviz_teleop_commander-msg:Human))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<HumanArray>)))
  ...
  "rviz_teleop_commander/HumanArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'HumanArray)))
  "Returns string type for a message object of type 'HumanArray"
  "rviz_teleop_commander/HumanArray")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<HumanArray>)))
  ...
  (cl:format cl:nil "Human[] humans~%~%~%================================================================================~%MSG: rviz_teleop_commander/Human~%int64 id~%int64 type~%int64 state~%geometry_msgs/Pose pose~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'HumanArray)))
  "Returns full string definition for message of type 'HumanArray"
  (cl:format cl:nil "Human[] humans~%~%~%================================================================================~%MSG: rviz_teleop_commander/Human~%int64 id~%int64 type~%int64 state~%geometry_msgs/Pose pose~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
