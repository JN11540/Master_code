...
(cl:defmethod cl:initialize-instance :after ((m <groupChart>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'groupChart)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rviz_teleop_commander-msg:<groupChart> is deprecated: use rviz_teleop_commander-msg:groupChart instead.")))

(cl:ensure-generic-function 'numHuman-val :lambda-list '(m))
(cl:defmethod numHuman-val ((m <groupChart>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rviz_teleop_commander-msg:numHuman-val is deprecated.  Use rviz_teleop_commander-msg:numHuman instead.")
  (numHuman m))

(cl:ensure-generic-function 'riskFactor-val :lambda-list '(m))
(cl:defmethod riskFactor-val ((m <groupChart>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rviz_teleop_commander-msg:riskFactor-val is deprecated.  Use rviz_teleop_commander-msg:riskFactor instead.")
  (riskFactor m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<groupChart>)))
  ...
  "rviz_teleop_commander/groupChart")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'groupChart)))
  "Returns string type for a message object of type 'groupChart"
  "rviz_teleop_commander/groupChart")
