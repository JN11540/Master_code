...
if("TRUE" STREQUAL "TRUE")
  set(rostest_SOURCE_PREFIX /home/edward/catkin_ws/src/ros_comm/tools/rostest)
  set(rostest_DEVEL_PREFIX /home/edward/catkin_ws/devel)
  set(rostest_INSTALL_PREFIX "")
  set(rostest_PREFIX ${rostest_DEVEL_PREFIX})
else()
  set(rostest_SOURCE_PREFIX "")
  set(rostest_DEVEL_PREFIX "")
  set(rostest_INSTALL_PREFIX /home/edward/catkin_ws/install)
...
if(NOT "/home/edward/catkin_ws/src/ros_comm/tools/rostest/include;/usr/include " STREQUAL " ")
  set(rostest_INCLUDE_DIRS "")
  set(_include_dirs "/home/edward/catkin_ws/src/ros_comm/tools/rostest/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rostest' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/edward/catkin_ws/src/ros_comm/tools/rostest/${idir}'.  ${_report}")
    endif()
    _list_append_unique(rostest_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/usr/lib/x86_64-linux-gnu/libboost_thread.so.1.71.0")
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT rostest_NUM_DUMMY_TARGETS)
      set(rostest_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::rostest::wrapped-linker-option${rostest_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR rostest_NUM_DUMMY_TARGETS "${rostest_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::rostest::wrapped-linker-option${rostest_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND rostest_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(rostest_EXPORTED_TARGETS ${${rostest_dep}_EXPORTED_TARGETS})
endforeach()
