...
if("TRUE" STREQUAL "TRUE")
  set(topic_tools_SOURCE_PREFIX /home/edward/catkin_ws/src/ros_comm/tools/topic_tools)
  set(topic_tools_DEVEL_PREFIX /home/edward/catkin_ws/devel)
  ...
  set(topic_tools_INSTALL_PREFIX /home/edward/catkin_ws/install)
...
if(NOT "/home/edward/catkin_ws/devel/include;/home/edward/catkin_ws/src/ros_comm/tools/topic_tools/include " STREQUAL " ")
  set(topic_tools_INCLUDE_DIRS "")
  set(_include_dirs "/home/edward/catkin_ws/devel/include;/home/edward/catkin_ws/src/ros_comm/tools/topic_tools/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "http://ros.org/wiki/topic_tools " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/topic_tools' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'topic_tools' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'topic_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/edward/catkin_ws/src/ros_comm/tools/topic_tools/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT topic_tools_NUM_DUMMY_TARGETS)
      set(topic_tools_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::topic_tools::wrapped-linker-option${topic_tools_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR topic_tools_NUM_DUMMY_TARGETS "${topic_tools_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::topic_tools::wrapped-linker-option${topic_tools_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND topic_tools_LIBRARIES "${interface_target_name}")
...
set(topic_tools_EXPORTED_TARGETS "topic_tools_generate_messages_cpp;topic_tools_generate_messages_eus;topic_tools_generate_messages_lisp;topic_tools_generate_messages_nodejs;topic_tools_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${topic_tools_dep}_FOUND)
      find_package(${topic_tools_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${topic_tools_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(topic_tools_EXPORTED_TARGETS ${${topic_tools_dep}_EXPORTED_TARGETS})
endforeach()
