...
namespace pcl_ros
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(MLSConfig &config, const MLSConfig &max, const MLSConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const MLSConfig &config1, const MLSConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, MLSConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const MLSConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, MLSConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const MLSConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const MLSConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, MLSConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(MLSConfig::AbstractParamDescriptionConstPtr(new MLSConfig::ParamDescription<int>("spatial_locator", "int", 0, "Set the spatial locator", "{'enum': [{'name': 'ANN', 'type': 'int', 'value': 0, 'srcline': 9, 'srcfile': '/home/edward/catkin_ws/src/perception_pcl/pcl_ros/cfg/MLS.cfg', 'description': 'ANN', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'FLANN', 'type': 'int', 'value': 1, 'srcline': 9, 'srcfile': '/home/edward/catkin_ws/src/perception_pcl/pcl_ros/cfg/MLS.cfg', 'description': 'FLANN', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'organized', 'type': 'int', 'value': 2, 'srcline': 9, 'srcfile': '/home/edward/catkin_ws/src/perception_pcl/pcl_ros/cfg/MLS.cfg', 'description': 'Dense/organized data locator', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'Set the spatial locator'}", &MLSConfig::spatial_locator)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(MLSConfig::AbstractParamDescriptionConstPtr(new MLSConfig::ParamDescription<int>("spatial_locator", "int", 0, "Set the spatial locator", "{'enum': [{'name': 'ANN', 'type': 'int', 'value': 0, 'srcline': 9, 'srcfile': '/home/edward/catkin_ws/src/perception_pcl/pcl_ros/cfg/MLS.cfg', 'description': 'ANN', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'FLANN', 'type': 'int', 'value': 1, 'srcline': 9, 'srcfile': '/home/edward/catkin_ws/src/perception_pcl/pcl_ros/cfg/MLS.cfg', 'description': 'FLANN', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'organized', 'type': 'int', 'value': 2, 'srcline': 9, 'srcfile': '/home/edward/catkin_ws/src/perception_pcl/pcl_ros/cfg/MLS.cfg', 'description': 'Dense/organized data locator', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'Set the spatial locator'}", &MLSConfig::spatial_locator)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 9 "/home/edward/catkin_ws/src/perception_pcl/pcl_ros/cfg/MLS.cfg"
      const int MLS_ANN = 0;
//#line 9 "/home/edward/catkin_ws/src/perception_pcl/pcl_ros/cfg/MLS.cfg"
