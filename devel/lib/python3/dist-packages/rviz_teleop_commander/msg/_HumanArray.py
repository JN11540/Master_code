...
"""autogenerated by genpy from rviz_teleop_commander/HumanArray.msg. Do not edit."""
import codecs
import sys
...
class HumanArray(genpy.Message):
  ...
  _type = "rviz_teleop_commander/HumanArray"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """Human[] humans
...
"""
  __slots__ = ['humans']
  _slot_types = ['rviz_teleop_commander/Human[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = rviz_teleop_commander.msg.Human()
        _x = val1
        start = end
        end += 24
