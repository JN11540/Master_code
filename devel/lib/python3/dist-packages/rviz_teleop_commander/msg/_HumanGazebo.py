...
"""autogenerated by genpy from rviz_teleop_commander/HumanGazebo.msg. Do not edit."""
import codecs
import sys
...
class HumanGazebo(genpy.Message):
  _md5sum = "d6a602bef3cc30802df3048df084e986"
  _type = "rviz_teleop_commander/HumanGazebo"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """string item_name
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(HumanGazebo, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.item_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.item_name = str[start:end]
      _x = self
      start = end
      end += 56
