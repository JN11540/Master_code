...
"""autogenerated by genpy from rgbd_object_detection/MaskrcnnResult.msg. Do not edit."""
import codecs
import sys
...
class MaskrcnnResult(genpy.Message):
  _md5sum = "d917c3c8bcf1773974d71f637e6ff807"
  _type = "rgbd_object_detection/MaskrcnnResult"
...
bool do_rectify
"""
  __slots__ = ['header','color_image','boxes','class_ids','class_names','scores','masks']
  _slot_types = ['std_msgs/Header','sensor_msgs/Image','sensor_msgs/RegionOfInterest[]','int32[]','string[]','float32[]','sensor_msgs/Image[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,color_image,boxes,class_ids,class_names,scores,masks
    ...
    """
    if args or kwds:
      super(MaskrcnnResult, self).__init__(*args, **kwds)
